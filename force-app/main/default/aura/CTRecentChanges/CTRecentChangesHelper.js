    ...
    getColumns: function (viewType) {
        if (viewType === "person") {
            return [
                ...
                { label: "View", type: "button", initialWidth: 135, typeAttributes: { label: "View/Update", name: "view_details", title: "Click to View Person Details" } }
            ];
        } else {
            return [
                { label: "Name", fieldName: "Name", type: "text" },
                ...
                { label: "Status Update Date", fieldName: "Status_Update_Date__c", type: "date" },
                { label: "View", type: "button", initialWidth: 135, typeAttributes: { label: "View/Update", name: "view_details", title: "Click to View Location Details" } }
            ];
        }
    },
